...
参考文档：
- _bmad/bmm/3-solutioning/artifacts/TECH_STACK.md - 技术栈清单
- _bmad/bmm/4-implementation/artifacts/BACKEND_STRUCTURE.md - 后端架构
- _bmad/bmm/4-implementation/artifacts/FRONTEND_GUIDELINES.md - 前端指南
输出要求：
- 架构决策必须有 ADR 文档
...
参考文档：
- _bmad/bmm/4-implementation/artifacts/BACKEND_STRUCTURE.md - 后端架构（含 API 端点合约）
- _bmad/bmm/3-solutioning/artifacts/Supabase 核心知识体系.md
开发规范：
...
| 文档 | 路径 | 用途 |
|------|------|------|
| 技术栈清单 | `_bmad/bmm/3-solutioning/artifacts/TECH_STACK.md` | 技术栈版本锁定 |
| 多智能体协同方案 | `_bmad/bmm/4-implementation/artifacts/MULTI_AGENT_COLLABORATION.md` | Agent 配置详情 |
| 实现计划 | `_bmad/bmm/2-plan-workflows/artifacts/IMPLEMENTATION_PLAN.md` | P0/P1/P2 阶段任务分配 |
| 前端指南 | `_bmad/bmm/4-implementation/artifacts/FRONTEND_GUIDELINES.md` | 前端开发规范 |
| 后端架构 | `_bmad/bmm/4-implementation/artifacts/BACKEND_STRUCTURE.md` | 后端 API 设计 |

### 8.2 技术栈知识库

| 技术栈 | 文档路径 |
|--------|----------|
| Next.js 16 | `_bmad/bmm/3-solutioning/artifacts/Next.js 核心知识体系.md` |
| Zustand | `_bmad/bmm/3-solutioning/artifacts/Zustand 核心知识体系.md` |
| TanStack Query | `_bmad/bmm/3-solutioning/artifacts/TanStack Query 核心知识体系.md` |
| Supabase | `_bmad/bmm/3-solutioning/artifacts/Supabase 核心知识体系.md` |
| React Hook Form + Zod | `_bmad/bmm/3-solutioning/artifacts/React Hook Form + Zod 核心知识体系.md` |
| Vitest + Playwright | `_bmad/bmm/3-solutioning/artifacts/Vitest + Playwright 核心知识体系.md` |
