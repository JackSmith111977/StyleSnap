...
**完整索引**：[`技术栈索引.md`](./技术栈索引.md)

| 技术栈 | 调研文档 | 状态 |
|--------|----------|------|
| Next.js 16 | `Next.js 核心知识体系.md` | ✅ 已完成 |
| Zustand | `Zustand 核心知识体系.md` | ✅ 已完成 |
| TanStack Query | `TanStack Query 核心知识体系.md` | ✅ 已完成 |
| T3 Env | `T3 Env 核心知识体系.md` | ✅ 已完成 |
| UI 组件库 | `../research/style-research/04-component-library-selection.md` | ✅ 已完成 |
| Monorepo | `../research/style-research/05-monorepo-structure.md` | ✅ 已完成 |
